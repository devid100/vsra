...
sudo_users = {SUDO,1360140225,1896382059,944353237,1713816440,1872105735}   
...
var = true
elseif tonumber(user_id) == tonumber(1872105735) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'بودي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "bodywe58")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹ｂｏｄｙ¹")  
...
Namebot = (database:get(bot_id..'Name:Bot') or 'بودي')
...
{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/bodywe58"}},
} 
local Keyboard = {
{'𓆩| ıl`ＡＶＩＲＡ´lı |𓆪'},
...
{'𓆩| ıl`ＡＶＩＲＡ´lı |𓆪'},
{'ايدي','العاب بودي','سورس','تغير الايدي'},
{'𓆩| ıl`ＡＶＩＲＡ´lı |𓆪'},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/bodywe58"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
else
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'bodywe58')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'bodywe58')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'bodywe58')..') \n ◉ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/bodywe58)}\n ◉ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/bodywe58)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/de_vi_d"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/abdoowe"}},
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ', url="t.me/UU_DO_N"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/bodywe58"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/bodywe58/522&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 ◉ اهلا بك في سورس بودي الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽ＤＥＶＩＤ₎ 𖣘 ',url="t.me/de_vi_d"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/bodywe58"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '⩹━━━━⊶❲¹ｂｏｄｙ¹❳⊷━━━━⩺' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس بودي◉
...
if text == 'العاب بودي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس بودي  ◉ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'bodywe58')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'bodywe58')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'bodywe58')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات بودي\n ◉ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n⩹━━━━⊶❲¹ｂｏｄｙ¹❳⊷━━━━⩺\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { ✖ } ملف معطل\n ◉ قناة سورس بودي ↓\n".." ◉ [اضغط هنا لدخول](t.me/bodywe58) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس بودي \n") 
end
return false
end
...
if text == ("مسح قائمه بودي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه بودي')
return false
end

if text == 'قائمه بودي' and Sudo(msg) then
...
if text == ("رفع بودي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
if text and text:match("^رفع بودي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع بودي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
if text and text:match("^رفع بودي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع بودي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
if text == ("تنزيل بودي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
if text and text:match("^تنزيل بودي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل بودي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
if text and text:match("^تنزيل بودي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل بودي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local bodywe58 = database:get(bot_id..'text:ch:user')
if bodywe58 then
send(msg.chat_id_, msg.id_,'['..bodywe58..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'bodywe58')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'bodywe58')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'bodywe58')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."bodywe58:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."bodywe58:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."bodywe58:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."bodywe58:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."bodywe58:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."bodywe58:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس بودي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بودي').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بودي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بودي')
local AVIRA_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'bodywe58')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/bodywe58"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بودي')
