...
if res ~= 200 then
print('\27[0;31m═───═𝗦𝗢𝗢𝗡𝗣𝗟𝗨𝗦═───═\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪𖢠━━━━━━𝘀𝗼𝗼𝗼𝗻━━━━━𖢠≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m═───═𝗦𝗢𝗢𝗡𝗣𝗟𝗨𝗦═───═ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
usertext = '\n 𖢠 العضو ⤶ ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 𖢠 تم ترقيته مطور'
...
usertext = '\n 𖢠 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖢠 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢠 العضو ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 𖢠 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 𖢠 العضو : {["..data.first_name_.."](T.ME/s_o_op)}\n 𖢠 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖢠 عذرا ⤶ {["..data.first_name_.."](T.ME/s_o_op)}\n 𖢠 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖢠 بواسطه ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 𖢠 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢠 بواسطه ⤶ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 𖢠 تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 𖢠 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1360140225) then
send(msg.chat_id_, msg.id_, " 𖢠 لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1609173922) then
send(msg.chat_id_, msg.id_, " 𖢠 لا يمكنك كتم مبرمج السورس \n")
...
if Get_info then
local TextS = "\n 𖢠 اهلا بك في متجر ملفات سون\n 𖢠 ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n═───═𝗦𝗢𝗢𝗡 𝗣𝗟𝗨𝗦═───═\n 𖢠 علامة تعني { ✔️ } ملف مفعل\n 𖢠 علامة تعني { ✖ } ملف معطل\n 𖢠 قناة سورس سون ↓\n".." 𖢠 [اضغط هنا لدخول](t.me/s_o_op) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖢠 عذرا الملف لايدعم سورس سون \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖢠 لعضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖢠 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖢠 العضو ⤶ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢠 العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖢠 العضو ⤶ ['..result.title_..'](t.me/'..(text1[3] or 's_o_op')..')'..'\n 𖢠 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/s_o_op)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/s_o_op)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/s_o_op)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/s_o_op)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/s_o_op)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/s_o_op)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/s_o_op)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/s_o_op)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/s_o_op)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/s_o_op)') 
return false
end
end
end
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙾𝙾𝙽', url="t.me/s_o_op"},
