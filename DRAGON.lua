...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/zoro283/vvvvvv/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1360140225,1898097577,1804119251,1748966653}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سيزر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "sezrrrrrrrrrrrr")
local NameUser = "𖣥 بواسطه ← ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "𖣥 اسم المستخدم ← ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"𖣥 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝐒𝐄𝐙𝐑")  
...
send(chat,msg.id_," 𖣥  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 𖣥  جاري ...\n 𖣥  رفع الملف الان")
else
send(chat,msg.id_,"* 𖣥 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 𖣥 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖣥 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 𖣥 العضــو ← '..Name..'\n 𖣥 قام بالتكرار هنا وتم طرده '  
...
Text = '\n 𖣥 العضــو ← '..Name..'\n 𖣥 قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 𖣥 العضــو ← '..Name..'\n 𖣥 قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء 𖣥" then   
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖣥 تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
if sezrrrrrrrrrrrr then
send(msg.chat_id_, msg.id_,'['..sezrrrrrrrrrrrr..']')
else
send(msg.chat_id_, msg.id_,' 𖣥 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  𖣥 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = 'انت الان المطور الاساسي في البوت \n سورس سيزر\n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/sezrrrrrrrrrrrr)'
local keyboard = {
{'الاحصائيات','المطور','الثانوين'},
{'فارس  مبرمج السورس','مبرمج السورس²'},
...
SourceDRAGONr = '𖣥اهلا عزيزي\n𖣥انا بوت اسمي سيزر\n𖣥اختصاصي حمايه الكروبات\n𖣥من تكرار والسبام والتوجيه والخ…\n𖣥لتفعيلي اتبع الاخطوات…↓\n𖣥اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ←{ منشئ او المشرفين } بتفعيل فقط\n[𖣥معرف المطور '
end 
...
send(msg.sender_user_id_, msg.id_,' 𖣥 تم ارسال رسالتك\n 𖣥 سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 𖣥 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 𖣥 المستخدم ← '..Name..'\n 𖣥 تم حظره من التواصل'
...
Text = '\n 𖣥 تم تفعيل البوت الخدمي ' 
else
Text = '\n 𖣥 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل البوت الخدمي' 
else
Text = '\n 𖣥 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 𖣥 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖣥 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖣥 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖣥 تم حذف كليشه ستارت')
end
...
echo '⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n𖣥✔{ الــدخــول } \n⇎ *'`whoami`'*'
echo '⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n𖣥✔{ مـده تـشغيـل الـسـيـرفـر }\n⇎ *'"$uptime"'*'
]]):read('*all'))  
end

if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/zoro283/vvvvvv/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'𖣥 تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖣥 اصدار سورس سيزر { s: 6.7}')
end
if text == 'فارس  مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV FARES](t.me/abdoelasill)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽FÃ Ŕ È Ś₎ ✤ ', url="t.me/abdoelasill"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽oxgen vip₎ ✤ ',url="t.me/E_S_K_A_R_1"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/sezrrrrrrrrrrrr)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/sezrrrrrrrrrrrr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/IIabdoelasillbot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ TＷＡＳＯＬ 𖣥  ❩ ', url="t.me/IIabdoelasillbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
Text = ' الاحصائيات 𖣥 \n'..' 𖣥 عدد الجروبات ← {'..Groups..'}'..'\n 𖣥  عدد المشتركين ← {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_," 𖣥 ارسل الان اذاعتك؟ \n 𖣥 للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 𖣥 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖣥 •\n• لايمكنك استخدام البوت 𖣥 •\n• عليك الاشتراك في القناة 𖣥 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'𖣥 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'𖣥 عدد المشتركين الان ← ( '..#pv..' )\n𖣥 تم ازالة ← ( '..sendok..' ) من المشتركين\n𖣥  الان عدد المشتركين الحقيقي ← ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖣥 لا يوجد كروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖣥 تم ازالة ← { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖣥 تم ازالة ← {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖣥  عدد الجروبات الان ← { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖣥  الان عدد الجروبات الحقيقي ← { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣥 لا تستطيع استخدام البوت \n  𖣥 يرجى الاشتراك بالقناه اولا \n  𖣥 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖣥 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖣥 العضو ← ['..result.title_..'](t.me/'..(username or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖣥 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣥 العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..') \n 𖣥 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 𖣥 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖣥' then   
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 𖣥 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖣥 تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖣥 تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 𖣥 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 𖣥 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖣥 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖣥 عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖣥 البوت ادمن في القناة \n 𖣥 تم تفعيل الاشتراك الاجباري في \n 𖣥 ايدي القناة ('..data.id_..')\n 𖣥 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖣥 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 𖣥 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 𖣥 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 𖣥 تم تغيير وصف الجروب')
return false  
end 
-----------------------------------------------¹𝐒𝐄𝐙𝐑---------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 𖣥 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 𖣥 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 𖣥 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 𖣥 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖣥 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖣥 العضو : {["..data.first_name_.."](T.ME/sezrrrrrrrrrrrr)}\n 𖣥 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 𖣥 عذرا ← {[@"..data.username_.."]}\n 𖣥 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 𖣥 عذرا ← {["..data.first_name_.."](T.ME/sezrrrrrrrrrrrr)}\n 𖣥 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖣥 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖣥 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣥 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣥 بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣥 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' 𖣥 تم تفعيل كروب جديده\n'..
'\n 𖣥 بواسطة {'..Name..'}'..
'\n 𖣥 ايدي الجروب {'..IdChat..'}'..
'\n 𖣥 اسم الجروب {['..NameChat..']}'..
'\n 𖣥 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖣥 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖣥 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣥 بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣥 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣥 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣥 بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣥 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/zoro283/vvvvvv/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/zoro283/vvvvvv/main/library')
os.execute('wget https://raw.githubusercontent.com/zoro283/vvvvvv/main/File_Bot')
send(msg.chat_id_, msg.id_,' 𖣥 تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖣥 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖣥 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖣥$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖣥 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," 𖣥 الاشتراك الاجباري مفعل \n 𖣥 على القناة ← ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖣥 اهلا عزيزي المطور \n 𖣥 ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖣥 تم تعطيل الاشتراك الاجباري")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖣥 تم تفعيل الاشتراك الاجباري \n 𖣥 على القناة ← ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 𖣥 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
...
send(msg.chat_id_, msg.id_, '𖣥 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, '𖣥 تم الغاء كتم الاسم '..delBn)
...
texts = "𖣥 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n𖣥 قائمة الاسماء المكتومه \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "𖣥 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '𖣥 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '𖣥 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'𖣥 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'𖣥 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, '𖣥 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "𖣥 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "sezrrrrrrrrrrrr")..")\n𖣥 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n𖣥 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹oxgen vip¹˼ 𓌺 ',url="t.me/E_S_K_A_R_1"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/E_S_K_A_R_1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/abdoelasill"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/E_S_K_A_R_1"}},
{{text = '  ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌 ', url="t.me/sezrrrrrrrrrrrr"}},
{{text = '   ²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝙿𝙼  ', url="t.me/sezrrrrrrrrrrrr"}},
}https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sezrrrrrrrrrrrr&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 𖣥 اهلا بك في سورس سيزر الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  𖣥 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽FÃ Ŕ È Ś₎ 𖣘 ',url="t.me/abdoelasill"}},
{{text = '  𖣘 ⁽oxgen vip₎ 𖣘 ',url="t.me/E_S_K_A_R_1"}},
{{text = '  ❨ TＷＡＳＯＬ 𖣥  ❩ ',url="t.me/IIabdoelasillbot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
"‏ ‏ممكن اكون اختارت غلط بس والله حبيت بجد🖇️",
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة.𖣥💜",
...
"ويُرهقني أنّي مليء بما لا أستطيع قوله.✨",
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖣥 ",
"‏ ‏كل العالم يهون بس الدنيا بينا تصفي 💙",
"‏ بعض الاِعتذارات يجب أن تُرفَضّ.",
"‏ ‏تبدأ حياتك محاولاً فهم كل شيء، وتنهيها محاولاً النجاة من كل ما فهمت.",
"‏ إن الأمر ينتهي بِنا إلى أعتياد أي شيء.",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/sezrrrrrrrrrrrr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺' then
local Text = [[ 
𖣥من أحسن السورسات على التليجرام سورس سيزر𖣥
...
if text == 'العاب سيزر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖣥 اهلا في قائمه الالعاب المتطوره سورس سيزر  𖣥 
...
send(msg.chat_id_, msg.id_,' 𖣥 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 𖣥 تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖣥 بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..') \n 𖣥 تـم قفـل الدردشه ')
end,nil)   
...
Text = '𖣥 تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = '𖣥 بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل نسبه الانوثه'
else
Text = '\n 𖣥 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 𖣥 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖣥 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣥 بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..') \n 𖣥 تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣥 بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..') \n 𖣥 تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣥 بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..') \n 𖣥 تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_,' 𖣥 تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,' 𖣥 تم قفل التكرار')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,' 𖣥 تم قفل التكرار بالتقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,' 𖣥 تم قفل التكرار بالكتم')
elseif text == 'فتح التكرار' and Mod(msg) then 
database:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
send(msg.chat_id_, msg.id_,' 𖣥 تم فتح التكرار')
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n𖣥تم قفل البوتات بالطرد\n𖣥تم وضع الايدي بدون صوره\n𖣥تم قفل التكرار بالطرد\n𖣥تم قفل الروابط\n𖣥تم قفل التوجيه\n𖣥تم قفل الملصقات\n𖣥تم قفل المتحركه\n𖣥تم قفل الفيديو\n𖣥تم قفل السب\n𖣥تم قفل التعديل\n𖣥تم قفل الفارسيه\n𖣥تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sezrrrrrrrrrrrr')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSoFi(msg) then    
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, ' 𖣥 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSoFi(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n 𖣥 تم مسح قائمه العام')
return false
end
...
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1360140225) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1898097577) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر فارس الغدارعام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1898097577) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1804119251) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك حظر فارس الغدارعام \n")
return false 
end
usertext = '\n 𖣥 العضو ← ['..result.title_..'](t.me/'..(username or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم حظره عام من الجروبات'
texts = usertext..status
...
if tonumber(userid) == tonumber(1898097577) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1360140225) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1898097577) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع كتم مبرمج السورس عام")
...
if tonumber(result.sender_user_id_) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع كتم فارس الغدارعام")
return false 
end
...
if result.id_ == tonumber(1360140225) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1804119251) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك كتم فارس الغدارعام \n")
return false 
end
if result.id_ == tonumber(1898097577) then
send(msg.chat_id_, msg.id_, " 𖣥 لا يمكنك كتم مبرمج السورس \n")
...
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n 𖣥 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 𖣥 قائمة مطورين البوت \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zoro283/vvvvvv/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖣥 اهلا بك في متجر ملفات سيزر\n 𖣥 ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n 𖣥 علامة تعني { ✔️ } ملف مفعل\n 𖣥 علامة تعني { ✖ } ملف معطل\n 𖣥 قناة سورس سيزر ↓\n".." 𖣥 [اضغط هنا لدخول](t.me/sezrrrrrrrrrrrr) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖣥 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖣥 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/zoro283/vvvvvv/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖣥 عذرا الملف لايدعم سورس سيزر \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖣥 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖣥 الملف ← "..file.."\n 𖣥 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/zoro283/vvvvvv/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖣥 تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 لا ����ستطيع استخدام البوت \n  𖣥 يرجى الاشتراك بالقناه اولا \n  𖣥 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if text == ("مسح قائمه سيزر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖣥 تم مسح قائمه سيزر')
return false
end

if text == 'قائمه سيزر' and Sudo(msg) then
...
if #list == 0 then
t = " 𖣥 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("رفع سيزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
if sezrrrrrrrrrrrr then
send(msg.chat_id_, msg.id_,'['..sezrrrrrrrrrrrr..']')
...
if text and text:match("^رفع سيزر @(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع سيزر (%d+)$") and Sudo(msg) then
...
if text == ("تنزيل سيزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
if sezrrrrrrrrrrrr then
send(msg.chat_id_, msg.id_,'['..sezrrrrrrrrrrrr..']')
...
if text and text:match("^تنزيل سيزر @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سيزر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
if sezrrrrrrrrrrrr then
send(msg.chat_id_, msg.id_,'['..sezrrrrrrrrrrrr..']')
...
if text and text:match("^تنزيل سيزر (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سيزر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
if sezrrrrrrrrrrrr then
send(msg.chat_id_, msg.id_,'['..sezrrrrrrrrrrrr..']')
...
t = "𖣥 المنشئين الاساسين تعالو مخرب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "𖣥 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","𖣥 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","𖣥 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 𖣥 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل امر تحويل'
else
Text = '\n 𖣥 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖣥 تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 𖣥 قائمة المنشئين الاساسين \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," 𖣥 حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-DRAGON")
send(msg.chat_id_, msg.id_," 𖣥 منشئ الجروب ← ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣥 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖣥 تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_,"𖣥 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖣥 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣥 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖣥 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"𖣥 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖣥 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n𖣥 قائمة مطورين الثانوين للبوت \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_, "\n𖣥 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖣥 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖣥 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖣥  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣥 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖣥 قائمة مميزين الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖣥 لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣥 العضو ← '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖣥 قائمة متوحدين الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣥 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖣥 قائمه زوجات الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣥 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣥 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
local  statuss  = '\n 𖣥 تم رفع المتهم حمار بالجروب\n 𖣥 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖣥 قائمة وتكات الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖣥 قائمة القرود الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
local  statuss  = '\n 𖣥 تم رفع قرد في الجروب\n 𖣥 تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖣥 قائمة البقرات الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
local  statuss  = '\n 𖣥 تم رفع بقره في الجروب\n 𖣥 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تنزيل بقره من الجروب\n 𖣥 تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع االاكساس')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣥 قائمة القلوب في الجروب\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣥 قائمة رقاصات الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
local statuss = '\n 𖣥 تم رفع رقاصه في الجروب\n 𖣥 مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status = '\n 𖣥 تم تنزيل رقاصه من الجروب\n 𖣥 بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖣥 قائمة المتناكين الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣥 قائمة حكاكين الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖣥 تم رفع حكاك في الجروب\n 𖣥 احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣥 تم تنزيل حكاك من الجروب\n 𖣥 لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 𖣥 قائمة نسوان الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖣥 تم رفع مره في الجروب\n 𖣥 ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣥 تم تنزيل مره من الجروب\n 𖣥 بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖣥 قائمه ازواج الجروب \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣥 تم زواجكم بنجاح في الجروب \n 𖣥 الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣥 تم طلاقكم بنجاح في الجروب\n 𖣥 اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖣥 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖣥  المستخدم ← ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖣥 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖣥 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖣥 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣥 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖣥 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣥 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣥 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥  الايدي ← `'..result.sender_user_id_..'`\n 𖣥  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥  الايدي ← `'..result.sender_user_id_..'`\n 𖣥  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n 𖣥 اعدادات الجروب كتالي √↓'..
'\nء⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺'..
'\n 𖣥  علامة ال {🔓} تعني مفعل'..
'\n 𖣥  علامة ال {🔐} تعني معطل'..
'\nء⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺'..
'\n 𖣥  الروابط ← { '..lock_links..
' }\n'..' 𖣥  المعرفات ← { '..lock_user..
' }\n'..' 𖣥  التاك ← { '..lock_hash..
' }\n'..' 𖣥  البوتات ← { '..lock_bots..
' }\n'..' 𖣥  التوجيه ← { '..lock_fwd..
' }\n'..' 𖣥  التثبيت ← { '..lock_pin..
' }\n'..' 𖣥  الاشعارات ← { '..lock_tagservr..
' }\n'..' 𖣥  الماركدون ← { '..lock_mark..
' }\n'..' 𖣥  التعديل ← { '..lock_edit..
' }\n'..' 𖣥  تعديل الميديا ← { '..lock_edit_med..
' }\nء⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺'..
'\n'..' 𖣥  الكلايش ← { '..lock_spam..
' }\n'..' 𖣥  الكيبورد ← { '..lock_inlin..
' }\n'..' 𖣥  الاغاني ← { '..lock_vico..
' }\n'..' 𖣥  المتحركه ← { '..lock_gif..
' }\n'..' 𖣥  الملفات ← { '..lock_file..
' }\n'..' 𖣥  الدردشه ← { '..lock_text..
...
' }\n'..' 𖣥  التكرار ← { '..flood..
' }\n'..' 𖣥  الترحيب ← { '..welcome..
' }\n'..' 𖣥  عدد التكرار ← { '..NUM_MSG_MAX..
' }\nء⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺'..
'\n 𖣥  علامة ال {🔓} تعني مفعل'..
'\n 𖣥  علامة ال {🔐} تعني معطل'..
'\nء⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺'..
'\n'..' 𖣥  امر صيح ← { '..kickme..
' }\n'..' 𖣥  امر اطردني ← { '..sehuser..
' }\n'..' 𖣥  امر منو ضافني ← { '..addme..
' }\n'..' 𖣥  الردود ← { '..rdmder..
' }\n'..' 𖣥  الردود العامه ← { '..rdsudo..
' }\n'..' 𖣥  الايدي ← { '..idgp..
' }\n'..' 𖣥  الايدي بالصوره ← { '..idph..
' }\n'..' 𖣥  الرفع ← { '..setadd..
' }\n'..' 𖣥  الحظر ← { '..banm..' }\n\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n 𖣥 قناة سورس سيزر ↓\n [ ¹𝐒𝐄𝐙𝐑](t.me/sezrrrrrrrrrrrr) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 𖣥 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖣥 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖣥 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖣥 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖣥 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖣥 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖣥 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," 𖣥 حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 𖣥 تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖣥 تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
...
if linkgpp.ok == true then 
local Teext = '𖣥'..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = ta.title_, url=linkgpp.result}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
send(msg.chat_id_, msg.id_,'𖣥لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
...
send(msg.chat_id_,msg.id_," 𖣥 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖣥 ارسل لي الترحيب الان'
tt = '\n 𖣥 تستطيع اضافة مايلي !\n 𖣥 دالة عرض الاسم ←{`name`}\n 𖣥 دالة عرض المعرف ←{`user`}'
...
GetWelcome = ' 𖣥 لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖣥 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖣥 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖣥 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖣥 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 𖣥 ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 𖣥 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖣥 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖣥 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣥 تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖣥 تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖣥 لا توجد بوتات في الجروب")
else
local t = ' 𖣥 عدد البوتات هنا >> {'..c..'}\n 𖣥 عدد البوتات التي هي ادمن >> {'..x..'}\n 𖣥 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n 𖣥 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖣥 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖣥 ملاحضه علامة ال (𖣥) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖣥 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖣥 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖣥 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖣥 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 𖣥 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖣥 لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖣥 قائمة الصلاحيات المضافه \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖣥 ارسل نوع الرتبه \n 𖣥 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖣥 تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖣥 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖣥 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖣥 تستطيع اضافه صلاحيات {مميز - عضو} \n 𖣥 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖣥  تستطيع اضافه صلاحيات {عضو} \n 𖣥 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖣥 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣥 العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'sezrrrrrrrrrrrr')..')'..'\n 𖣥 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖣥 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖣥 عدد رسائلك ← { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 30000 then 
send(msg.chat_id_, msg.id_,'𖣥تستطيع التنظيف 30000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖣥 تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖣥 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = "𖣥 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "𖣥 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "𖣥 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "𖣥 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'𖣥 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖣥 ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖣥 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖣥 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"𖣥 لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n𖣥 تم تنزيل الشخص من الرتب التاليه \n𖣥  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n𖣥  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖣥 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖣥 قائمة الردود العامه \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖣥 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖣥 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,"𖣥 تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖣥تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖣥 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖣥 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖣥 ارسل الكلمه التي تريد حذفها')
...
local Text ='𖣥تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '¹𝐒𝐄𝐙𝐑.',url="t.me/sezrrrrrrrrrrrr"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,'𖣥لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖣥قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖣥 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..') '
status  = '\n𖣥 الايدي ← '..result.sender_user_id_..'\n𖣥تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣥 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣥  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
status  = '\n 𖣥  الايدي ← `'..result.sender_user_id_..'`\n 𖣥  تم حذف لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'𖣥وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖣥لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖣥صلاحيات البوت هي\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n𖣥  علامة ال {✔️} تعني مفعل\n𖣥  علامة ال {✖} تعني غير مفعل\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n𖣥تغير معلومات المجموعة ↞ '..INf..'\n𖣥حذف الرسائل ↞ '..DEL..'\n𖣥حظر المستخدمين ↞ '..REs..'\n𖣥دعوة المستخدمين ↞ '..INv..'\n𖣥ثتبيت الرسالة ↞ '..Pin..'\n𖣥اضافة مشرفين ↞ '..PRo)   
end
end
if text == "تعطيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' تم تعطيل الانستا')
database:set(bot_id.."sezrrrrrrrrrrrr:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."sezrrrrrrrrrrrr:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sezrrrrrrrrrrrr:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."sezrrrrrrrrrrrr:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"𖣥تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."sezrrrrrrrrrrrr:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "𖣥تم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."sezrrrrrrrrrrrr:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سيزر يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n𖣥المستخدم ~ ["..User_id .."] يصيح المشرفين \n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"𖣥ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖣥ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣥تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣥تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣥تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيزر').." غادر" or text == 'غادر' then  
...
Text = ' 𖣥 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖣥 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖣥 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖣥 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖣥 تم تفعيل الردود العامه' 
else
Text = '\n 𖣥 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل الردود العامه' 
else
Text = '\n 𖣥 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تفعيل الايدي بالصور' 
else
Text = '\n 𖣥 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\n 𖣥 تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖣥 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖣥 ايديه ~⪼ '..iduser..'\n 𖣥 معرفه ~⪼ '..username..'\n 𖣥 رتبته ~⪼ '..rtp..'\n 𖣥 تعديلاته ~⪼ '..edit..'\n 𖣥 نقاطه ~⪼ '..NUMPGAME..'\n 𖣥 جهاته ~⪼ '..Contact..'\n 𖣥 رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣥 المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣥 رتبتك في البوت ← '..rtp)
end


if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sezrrrrrrrrrrrr)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sezrrrrrrrrrrrr)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sezrrrrrrrrrrrr)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sezrrrrrrrrrrrr)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/sezrrrrrrrrrrrr)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sezrrrrrrrrrrrr)') 
return false
end
end
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'سيزر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سيزر')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
'اسمي  '..Namebot..' يوتكه🙈🍑',
'انا '..Namebot..' إلى عمرو مهاب كابوس الكلاب 𖣥',
}
local Text = [[
...
first_name = ' 𖣥 اسمك الاول ← {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖣥 اسمك الثاني ← {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖣥 ايديك ← '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sezrrrrrrrrrrrr')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' 𖣥 الايدي ← ('..iduser..')\n 𖣥 المعرف ← ('..username..')\n 𖣥 الرتبه ← ('..rtp..')\n 𖣥 نوع الكشف ← بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد') 
local iduser = userid 
send(msg.chat_id_, msg.id_,' 𖣥الايدي »> ('..iduser..')\n𖣥المعرف »> ('..username..')\n𖣥الرتبه »> ('..rtp..')\n𖣥نوع الكشف »> بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,' 𖣥المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖣥 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 𖣥 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖣥 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖣥 عدد الاعضاء : '..data.member_count_..
'\n\n 𖣥 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖣥  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖣥 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖣥 تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖣥 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖣥 لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖣥 لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖣥 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣥 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖣥 هوا ابن الكلب دا الي ضافك😹← '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣥 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣥 تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' 𖣥 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖣥 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل امر مين ضافني '
else
Text = '\n 𖣥 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖣥 تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖣥 بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖣥 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖣥 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣥 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖣥 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end 
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖣥 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖣥 عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
𝟓 𝟔 𖡻 #stast  ࿇🦄
𝟓 𝟔 𖡻 #id  ࿇🦄
𝟓 𝟔 𖡻 𝗖𝗛 - @sezrrrrrrrrrrrr 𖣥
]]}
local Text_Rand = List[math.random(#List)]
database:set(bot_id.."KLISH:ID"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'𖣥 تم تغير الايدي ارسل ايدي لرؤيته')
end
...
send(msg.chat_id_, msg.id_, '\n 𖣥 الصوره ~⪼ ليس لديك صور في حسابك'..'[\n🇧🇱-𝒖𝒔𝒆𝒓  '..username..'\n 🇧🇱-𝒎𝒔𝒈𝒔  '..Msguser..'\n 🇧🇱-𝒊𝒅 '..msg.sender_user_id_..'\n🇧🇱- 𝗖𝗛 @sezrrrrrrrrrrrr\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' 𖣥  ليس لديك سحكات'
else
Text = ' 𖣥 عدد سحكاتك *← { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖣥 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖣥 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖣥 لم تقم بأضافه احد'
else
Text = ' 𖣥 عدد جهاتك *← { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 𖣥 ايدي المجموعة ← ( '..msg.chat_id_..' )\n 𖣥 عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n 𖣥 عدد المحظورين ← ( *'..data.kicked_count_..' )*\n 𖣥 عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖣥 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "𖣥| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖣥 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖣥 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖣥 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖣥 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖣥 عدد نقاطك التي ربحتها هيه *← { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖣥 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖣥 ليس لديك نقاط في الالعاب\n 𖣥 اذا كنت تريد ربح نقاط \n 𖣥 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖣥 ليس لديك نقاط في هذه لعبه \n 𖣥 لزيادة نقاطك في اللعبه \n 𖣥 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖣥 تم خصم *← { '..NUMPY..' }* من نقاطك \n 𖣥 وتم اضافة* ← { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖣥 اهلا عزيزي البوت هنا ادمن'..'\n 𖣥 وصلاحياته هي ↓ \n━━━━━━━━━━'..'\n 𖣥 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 𖣥 حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n 𖣥 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 𖣥 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 𖣥 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 𖣥 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 𖣥 تم تغير رد المطور الى ← "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖣥 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖣥 الان يمكنك ارسال الكليشه ⓵')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'𖣥هاذا الامر خاص بالادمنيه\n𖣥ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local sezrrrrrrrrrrrr = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'𖣥لا تستطيع استخدام البوت \n 𖣥يرجى الاشتراك بالقناه اولا \n 𖣥اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
local Text =[[
...
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖣥 هاذا الامر خاص بالادمنيه\n 𖣥 ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local MRSoOoFi = database:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
{
{text = 'مميزات𖣥', callback_data="/change-photo"},
},
{ 
{text = 'الاوامر🎯', callback_data="/help90"},
},
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝐒𝐄𝐙𝐑', url="t.me/sezrrrrrrrrrrrr"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n 𖣥[ʙɪʟʟɪᴇ ᴠɪᴘ ᴤᴇʟᴀ ](t.me/sezrrrrrrrrrrrr)𖣥 ')
end

if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖣥 تم تعطيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖣥 تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, '𖣥 تم تعطيل الاله حاسبه')
...
send(msg.chat_id_, msg.id_,'𖣥 تم تفعيل الاله حاسبه')
...
keyboard.inline_keyboard = {
{
{text = 'BACK𖣥', callback_data="/help8"},
},
{
{text = 'اوامر الوضع', callback_data="/help3"},{text = 'اوامر التنزيل والرفع', callback_data="/help4"},
},
...
𖣥امسح
𖣥صلاحيه
𖣥قائمه منع المتحركات
𖣥قائمه منع الصور
𖣥قائمه منع الملصقات
𖣥مسح قائمه المنع
𖣥المحذوفين
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥مسح  امر + الامر القديم  
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥الاوامر المضافه ( لعرض الاوامر المضافه ) 
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥[ʙɪʟʟɪᴇ ᴠɪᴘ ᴤᴇʟᴀ ](t.me/sezrrrrrrrrrrrr)𖣥
]]
keyboard = {} 
...
𖣥تغير رد العضو + اسم
𖣥تغير امر الاوامر
𖣥تغير امر م1 ~ الئ م10
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺ 
𖣥اوامر المجموعه 📢 .
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥استعاده الاوامر 
𖣥تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖣥صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖣥كشف القيود
𖣥تعين الايدي
𖣥تغير الايدي
𖣥الحساب + ايدي الحساب
...
┇~ الصور + متحركه + ملصق ~
𖣥حظر ~ كتم ~ تقيد ~ طرد
𖣥المحظورين ~ المكتومين ~ المقيدين
𖣥الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
𖣥تقيد ~ كتم + الرقم + ساعه
𖣥تقيد ~ كتم + الرقم + يوم
𖣥تقيد ~ كتم + الرقم + دقيقه
𖣥تثبيت ~ الغاء تثبيت
𖣥الترحيب
𖣥الغاء تثبيت الكل
𖣥كشف البوتات
...
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥تفعيل ← تعطيل 
𖣥المجموعات ← المشتركين ← الاحصائيات
𖣥رفع ← تنزيل منشئ اساسي
𖣥مسح الاساسين ← المنشئين الاساسين
𖣥مسح المنشئين ← المنشئين
𖣥اسم ~ ايدي + بوت غادر 
𖣥اذاعه 
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺ ┉ ┉
𖣥اوامر مطور الاساسي
...
𖣥قائمه العام
𖣥مسح قائمه العام
𖣥جلب نسخه الاحتياطيه
𖣥رفع نسخه الاحتياطيه
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥اذاعه خاص
𖣥اذاعه
𖣥اذاعه بالتوجيه
...
𖣥جلب نسخه البوت
𖣥رفع نسخه البوت
𖣥ضع عدد الاعضاء + العدد
𖣥ضع كليشه المطور
𖣥تفعيل/تعطيل الاذاعه
𖣥تفعيل/تعطيل البوت الخدمي
𖣥تفعيل/تعطيل التواصل
𖣥تغير اسم البوت
𖣥اضف/مسح رد عام
𖣥الردود العامه
𖣥مسح الردود العامه
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥الاشتراك الاجباري
𖣥تعطيل الاشتراك الاجباري
𖣥تفعيل الاشتراك الاجباري
𖣥مسح رساله الاشتراك
𖣥تغير رساله الاشتراك
𖣥تغير الاشتراك
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥الاحصائيات
𖣥المشتركين
𖣥المجموعات 
𖣥تفعيل/تعطيل المغادره
𖣥مسح الجروبات
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥[ʙɪʟʟɪᴇ ᴠɪᴘ ᴤᴇʟᴀ ](t.me/sezrrrrrrrrrrrr)𖣥
]]
...
𖣥مصه بالرد
𖣥رزله بالرد 
𖣥شنو رئيك بهذا بالرد
𖣥شنو رئيك بهاي بالرد
𖣥تحب هذا
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥[ʙɪʟʟɪᴇ ᴠɪᴘ ᴤᴇʟᴀ ](t.me/sezrrrrrrrrrrrr)𖣥
]]
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '  ✤ ⁽SＯＵＲＣＥ₎ ✤', url="t.me/sezrrrrrrrrrrrr"}},
{{text = 'BACK𖣥 ', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥 بك في مميزات سورس سيزر𖣥
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
𖣥 مميزات الخاصه بسورس 𖣥
⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺
باد ⇜ اسئله محرجه
عقاب ⇜ عاقبني
قولي ⇜ بوستات 
...
{
{text = 'مميزات 𖣥', callback_data="/change-photo"},
},
{  
{text = 'الاوامر🎯', callback_data="/help90"},
},
...
send(msg.chat_id_, msg.id_,' 𖣥 تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' 𖣥 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 𖣥 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  𖣥 تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سيزر')
...
send(msg.chat_id_,0,''..t..'\n⩹━━━━⊶❲¹𝐒𝐄𝐙𝐑¹༼❳⊷━━━━⩺\n 𖣥 تم التعديل على الميديا\n 𖣥 الشخص الي قام بالتعديل\n 𖣥 ايدي الشخص ◂ '..result.sender_user_id_..'\n 𖣥 معرف الشخص←{ '..users..' }') 
end,nil)
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖣥 "..DRAGON1_Msg)
